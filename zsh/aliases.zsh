...
alias vtexwork='npm install -g vtex && vtex workspace reset && vtex config set env prod && vtex install vtex.builder-hub vtex.checkout vtex.asset-server vtex.sse-server && vtex link --verbose'
